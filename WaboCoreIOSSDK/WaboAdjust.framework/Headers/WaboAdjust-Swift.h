...
#ifndef WABOADJUST_SWIFT_H
#define WABOADJUST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WaboAdjust",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface WaboAdjust : NSObject <AdjustDelegate, WaboThirdUploadLoggerProtocol>
+ (WaboAdjust * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
/// is init complete
///
/// returns:
/// is init complete
...
///   </li>
/// </ul>
- (void)setGoogleDMA:(NSString * _Nonnull)dmaJson;
/// init sdk with json
...
/// returns:
/// attribution info
- (WaboBridgeResult * _Nonnull)getAttrInfo SWIFT_WARN_UNUSED_RESULT;
