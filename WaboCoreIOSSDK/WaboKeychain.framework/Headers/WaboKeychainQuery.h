...
NS_ASSUME_NONNULL_BEGIN
    ...
    #define WaboKeychain_SYNCHRONIZATION_AVAILABLE 1
#endif

#if __IPHONE_3_0 || __MAC_10_9
    // Keychain access group available at compile time
    #define WaboKeychain_ACCESS_GROUP_AVAILABLE 1
#endif

#ifdef WaboKeychain_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, WaboKeychainQuerySynchronizationMode) {
    WaboKeychainQuerySynchronizationModeAny,
    WaboKeychainQuerySynchronizationModeNo,
    WaboKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface WaboKeychainQuery : NSObject
...
#ifdef WaboKeychain_ACCESS_GROUP_AVAILABLE
...
@property (nonatomic) WaboKeychainQuerySynchronizationMode synchronizationMode;
#endif
...
/**
 ...
 WaboKeychain_SYNCHRONIZATION_AVAILABLE is only for compile time. If you are checking for the presence of synchronization,
