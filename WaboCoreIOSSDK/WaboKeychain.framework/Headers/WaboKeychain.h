...
//  WaboKeychain
//
//  Created by Bepic on 2024/3/19.
//

#import <Foundation/Foundation.h>

//! Project version number for WaboKeychain.
FOUNDATION_EXPORT double WaboKeychainVersionNumber;

//! Project version string for WaboKeychain.
FOUNDATION_EXPORT const unsigned char WaboKeychainVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <WaboKeychain/PublicHeader.h>
...
/**
 Error code specific to WaboKeychain that can be returned in NSError objects.
 For codes returned by the operating system, refer to SecBase.h for your
 platform.
 */
typedef NS_ENUM(OSStatus, WaboKeychainErrorCode) {
    /** Some of the arguments were invalid. */
    WaboKeychainErrorBadArguments = -1001,
};

/** WaboKeychain error domain */
extern NSString *const kWaboKeychainErrorDomain;

/** Account name. */
extern NSString *const kWaboKeychainAccountKey;
 ...
 */
extern NSString *const kWaboKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kWaboKeychainClassKey;

/** Item description. */
extern NSString *const kWaboKeychainDescriptionKey;

/** Item label. */
extern NSString *const kWaboKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kWaboKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kWaboKeychainWhereKey;
...
/**
 ...
 WaboKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
@interface WaboKeychain : NSObject
...
/**
 ...
 See the `NSString` constants declared in WaboKeychain.h for a list of keys that can be used when accessing the
...
#import <WaboKeychain/WaboKeychainQuery.h>
